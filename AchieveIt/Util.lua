...
--[[ Deprecated code since Bliizard removed the ability for addons to call player co-ordinates from map while in an instance.
...
AchieveIt.difficulty = {
	...
	isMythicDungeon = function()
		local _, _, difficulty = GetInstanceInfo();
		return difficulty == 23;
	end,
