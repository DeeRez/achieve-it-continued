...
local titleAchievements	= {
	...
	{ id = 10072, faction = AchieveIt.Factions.ALLIANCE },
	-- Rumble in the Jungle
	{ id = 10265, faction = AchieveIt.Factions.HORDE },
    -- Savage Hero
    9619,
    -- Scenaturday
...
local mountAchievements		= {
    ...
    2143,
	-- Lord of the Reins	
    { id = 10355, faction = AchieveIt.Factions.HORDE },
	-- Lord of the Reins	
    { id = 10356, faction = AchieveIt.Factions.ALLIANCE },
    -- Mount Parade
...
local itemAchievements = {
	...
	-- Azeroth's Top Twenty Tunes
		{ id = 9914, faction = AchieveIt.Factions.HORDE },
	-- Azeroth's Top Twenty Tunes
		{ id = 9912, faction = AchieveIt.Factions.ALLIANCE },
    ...
    7433,
	-- Petty Officer
        { id = 10255, faction = AchieveIt.Factions.HORDE },
	-- Petty Officer
        { id = 10172, faction = AchieveIt.Factions.ALLIANCE },	
	-- Powermonger: Gold
	9785,
    -- Pro Pet Crew
    6581,
...
local followerAchievements = {
	...
	-- Don't Call Me Junior
	   { id = 9928, faction = AchieveIt.Factions.ALLIANCE },
	-- Don't Call Me Junior
	   { id = 9901, faction = AchieveIt.Factions.HORDE },
	-- Leeeeeeeeeeeeeroy...?
	9058,
...
category:addChild(L["Followers"], followerAchievements);
